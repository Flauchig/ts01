...
const conta = {
    ...
    getGrupoTransacaos() {
        ...
        const transacoesOrdenadas = listaTransacoes.sort((t1, t2) => t2.data.getTime() - t1.data.getTime()); // aqui estou faznedo uma odenação das transaçoes descrescente 
        let labelAtualGrupoTransacao = ""; // aqui é um string que representa o nome do grupo 
